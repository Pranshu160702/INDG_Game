    ...
    public class EosTransport : Transport {
        ...
        public override void ClientConnect(string address) {
            ...
            if (!ClientActive() || client.Error) {
                Debug.Log($"[EosTransport] ClientConnect: starting client to {address}");

                client = Client.CreateClient(this, address);
                activeNode = client;

                if (EOSSDKComponent.CollectPlayerMetrics && EOSSDKComponent.GetMetricsInterface() != null) {
        ...
        public override void ServerStart() {
            ...
            if (!ServerActive()) {
                Debug.Log("[EosTransport] ServerStart: starting server");
        ...
        public int GetMaxSinglePacketSize(int channelId) => 1170 - 10;

        public override int GetMaxPacketSize(int channelId) => 1170 * maxFragments;

        public override int GetBatchThreshold(int channelId) => 1170;
